...
import { sendChatMessage, getChatHistory, getConversationMessages, deleteConversation } from '../controllers/chatController';
...
router.delete('/history/:id', authMiddleware, deleteConversation); // DELETE /api/chat/history/:id
